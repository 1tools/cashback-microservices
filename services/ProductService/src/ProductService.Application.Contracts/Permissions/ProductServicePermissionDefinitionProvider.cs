...
public class ProductServicePermissionDefinitionProvider : PermissionDefinitionProvider
{
    ...
    {
        var myGroup = context.AddGroup(ProductServicePermissions.GroupName);
        //Define your own permissions here. Example:
        //myGroup.AddPermission(ProductServicePermissions.MyPermission1, L("Permission:MyPermission1"));
    }
