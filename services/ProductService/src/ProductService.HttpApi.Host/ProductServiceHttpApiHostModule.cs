...
using ProductService.MultiTenancy;
...
public class ProductServiceHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<ProductServiceDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}ProductService.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<ProductServiceDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}ProductService.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<ProductServiceApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}ProductService.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<ProductServiceApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}ProductService.Application"));
            });
        }
    }
